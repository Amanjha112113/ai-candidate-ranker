...
2. **Semantic Score (30%)**: Combines two stages:
   - *Stage 1 (Bi-Encoder)*: Fast cosine similarity using `bge-small-en-v1.5` embeddings, multiplied by a narrative `authenticity` score to penalize synthetic "filler" templates.
